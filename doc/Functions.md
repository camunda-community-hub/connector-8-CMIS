...
## Create folder
Create a folder in the CMIS repository, under the folder parent. If recursiveName is true, the folderName can contains /, and then multiple folders can be created recursively For example, for 'usa/california/contracosta/Kensington', 4 folders will be created.
