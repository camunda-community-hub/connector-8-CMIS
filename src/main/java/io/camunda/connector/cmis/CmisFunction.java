...
@OutboundConnector(name = "PdfFunction", inputVariables = {  }, type = "c-cmis-function")
...
public class CmisFunction implements OutboundConnectorFunction, CherryConnector {
  ...
  public static final List<Class<?>> allFunctions = Arrays.asList(CreateFolderFunction.class,
      DeleteDocumentWorker.class, DeleteFolderWorker.class, DownloadDocumentFunction.class, ListCmisObjectFunction.class);
  ...
  public CmisOutput execute(OutboundConnectorContext outboundConnectorContext) throws Exception {
    ...
    try {
      ...
      throw new ConnectorException(CmisFunction.BPMNERROR_NO_CONNECTION_TO_CMIS, "No connection with ["+cmisInput.getCmisConnection());
    }
    ...
    throw new ConnectorException(BPMNERROR_UNKNOWN_FUNCTION, "PDFFunction Unknown function " + function + "]");
  ...
  public Map<String, String> getListBpmnErrors() {
    ...
    allErrors.put(BPMNERROR_UNKNOWN_FUNCTION, BPMNERROR_UNKNOWN_FUNCTION_EXPL);
    allErrors.put(BPMNERROR_NO_CONNECTION_TO_CMIS,BPMNERROR_NO_CONNECTION_TO_CMIS_EXPL);
   ...
   */
  private List<CmisSubFunction> getListSubFunctions() {
