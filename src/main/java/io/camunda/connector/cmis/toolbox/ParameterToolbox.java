...
public class ParameterToolbox {
    ...
    private static List<Map<String, Object>> getParameters(boolean inputParameters) {
        ...
        RunnerParameter chooseFunction = new RunnerParameter(CmisInput.CMIS_FUNCTION,
        ...
        return runnerParametersCollectList.stream().map(t -> t.toMap(CmisInput.CMIS_FUNCTION)).toList();
