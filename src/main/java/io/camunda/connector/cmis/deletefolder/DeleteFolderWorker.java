...
public class DeleteFolderWorker implements CmisSubFunction {
    ...
    public CmisOutput executeSubFunction(CmisConnection cmisConnection,
        ...
        if (folderId != null && folderPath != null) {
            throw new ConnectorException(CmisError.BPMNERROR_ERROR_DOUBLE_FOLDER, "");
        }
        ...
        if (cmisObject == null) {
            if (errorIfNotExist)
                throw new ConnectorException(CmisError.BPMNERROR_ERROR_FOLDER_NOT_EXIST,
        ...
        if (cmisObject instanceof Folder cmisFolder) {
            ...
            throw new ConnectorException(CmisError.BPMNERROR_ERROR_OBJECT_IS_NOT_A_FOLDER,
    ...
    public Map<String, String> getBpmnErrors() {
        return Map.of(CmisError.BPMNERROR_ERROR_DOUBLE_FOLDER, CmisError.BPMNERROR_ERROR_DOUBLE_FOLDER_EXPL,
                CmisError.BPMNERROR_ERROR_FOLDER_NOT_EXIST, CmisError.BPMNERROR_ERROR_FOLDER_NOT_EXIST_EXPL,
                CmisError.BPMNERROR_ERROR_OBJECT_IS_NOT_A_FOLDER, CmisError.BPMNERROR_ERROR_OBJECT_IS_NOT_A_FOLDER_EXPL);
    }
