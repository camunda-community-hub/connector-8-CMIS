package io.camunda.cherry.cmis;
...
public class CmisCherryToolbox {
  ...
  /*                                                                      */
  /* ******************************************************************** */
  public static final String GROUP_SOURCE_OBJECT = "Source Object";
  ...
  public static List<RunnerParameter> CmisListIdentifyObject = Arrays.asList(CmisSourceDocument, CmisObjectId,
      CmisFolderName, CmisFilter);
}
